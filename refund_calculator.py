...
# ─── 기간권 환불 테이블 ───────────────────────────────────────────────────────
# 각 상품의 (사용일수 상한, 환불금액) 브라켓 목록
# usage_days <= 상한 → 해당 환불금액 적용 (첫 매칭 기준)
PERIOD_PASS_REFUND_TABLE: dict = {
    "2주권": {
        "price": 55_000,        # 상품금액 55,000원
        "total_weeks": 2,
        "brackets": [
            (7,  22_000),       # 1주차 (1~7일): 결제금액의 40% 환불
            (14,      0),       # 2주차 이후 (8~14일): 환불 불가
        ],
    },
    "4주권": {
        "price": 119_000,       # 상품금액 119,000원
        "total_weeks": 4,
        "brackets": [
            (7,  76_300),       # 1주차 (1~7일)
            (14, 43_600),       # 2주차 (8~14일)
            (21, 21_800),       # 3주차 (15~21일)
            (28,      0),       # 4주차 이후 (22~28일): 환불 불가
        ],
    },
    "고정석 4주권": {
        "price": 179_000,       # 상품금액 179,000원
        "total_weeks": 4,
        "brackets": [
            (7,  125_300),      # 1주차 (1~7일)
            (14,  71_600),      # 2주차 (8~14일)
            (21,  35_800),      # 3주차 (15~21일)
            (28,       0),      # 4주차 이후: 환불 불가
        ],
    },
    "관리고정석 4주권": {
        "price": 229_000,       # 상품금액 229,000원
        "total_weeks": 4,
        "brackets": [
            (7,  160_300),      # 1주차 (1~7일)
            (14,  91_600),      # 2주차 (8~14일)
            (21,  45_800),      # 3주차 (15~21일)
            (28,       0),      # 4주차 이후: 환불 불가
        ],
    },
    "오픈행사 4주권": {
        "price": 79_000,        # 상품금액 79,000원
        "total_weeks": 4,
        "brackets": [
            (7,  55_300),       # 1주차 (1~7일): 약 70%
            (14, 31_600),       # 2주차 (8~14일): 40%
            (21, 15_800),       # 3주차 (15~21일): 20%
            (28,      0),       # 4주차 이후 (22~28일): 환불 불가
        ],
    },
}
...
TIME_PASS_PRICES: dict = {
    "100시간권":     95_000,    # 상품금액 95,000원
    "200시간권":    180_000,    # 상품금액 180,000원
    "오픈100시간권":  69_000,   # 상품금액 69,000원
}

HOURLY_DEDUCTION: int = 1_500   # 시간당 차감금액 (원)
TIME_PASS_EXPIRY_DAYS: int = 28  # 구매 후 28일 초과 시 환불 불가
